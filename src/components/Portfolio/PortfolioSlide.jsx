   ...
   componentDidMount(){
    ...
    closeIcons.forEach(icon => {
        icon.addEventListener('click',function(){
            slideCard.classList.add('d-none');
        })
    })
   }
  render() {
    return (
        <>
         <div className='position-fixed w-100 bg-black top-0 bg-opacity-50 slideCard'>
                <div className="slideWidth mx-auto py-5 my-5 rounded-3 text-center bg-white">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className='text-center my-5'>
                            <img src={cake} alt="" className='w-65 rounded-3' />
                        </div>
                        ...
                        <button className='rounded-3 p-2 px-3 bg-site text-white border-0 closeIcon'> <i className="fa-solid fa-xmark me-1"></i> <span>Close Window</span> </button>
                        </div>
                    </div>
                </div>
         </div>
